...
//    var idUser : ChallengeOfTheDay?
    ...
    func toDTO()->UserDTO{
        return UserDTO(firstName: firstName, lastName: lastName, userName: userName, email: email, streakNumber: streakNumber, challengeNumber: challengeNumber, imageProfil: imageProfil)
    }
}
